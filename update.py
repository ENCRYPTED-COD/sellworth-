...
filepath = 'C:\\Users\\ANIKET\\.gemini\\antigravity\\scratch\\sellworth\\src\\components\\FAQ.tsx'
with open(filepath, 'r', encoding='utf-8') as f:
    content = f.read()

content = re.sub(r'const faqs = \[.*?\];', js_array, content, flags=re.DOTALL)

with open(filepath, 'w', encoding='utf-8') as f:
    f.write(content)

print('Updated FAQ.tsx')
