const fs = require('fs');
const data = require('./temp.ts');

const oldProps = data.properties.filter(p => p.slug !== 'emaar-india-business-centre-sector-61' && p.slug !== 'ireo-skyon-penthouse-sector-60' && p.category === 'new-launch');
